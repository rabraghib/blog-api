 ...
 */
final class Version20200522181313 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE blogs (id INT AUTO_INCREMENT NOT NULL, poster_id INT NOT NULL, category_id INT DEFAULT NULL, main_img VARCHAR(255) NOT NULL, title VARCHAR(180) NOT NULL, intro VARCHAR(700) NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, lastupdate_at DATETIME NOT NULL, num_views INT NOT NULL, is_publushed TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_F41BCA702B36786B (title), INDEX IDX_F41BCA705BB66C05 (poster_id), INDEX IDX_F41BCA7012469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, blog_id_id INT NOT NULL, parent_id_id INT NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, last_update_at DATETIME NOT NULL, INDEX IDX_9474526C8FABDD9F (blog_id_id), INDEX IDX_9474526CB3750AF4 (parent_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
