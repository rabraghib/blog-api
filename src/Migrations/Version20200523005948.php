 ...
 */
final class Version20200523005948 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE blogs (id INT AUTO_INCREMENT NOT NULL, poster_id INT NOT NULL, category_id INT DEFAULT NULL, title VARCHAR(180) NOT NULL, main_img VARCHAR(255) NOT NULL, intro VARCHAR(700) NOT NULL, content LONGTEXT NOT NULL, num_views INT NOT NULL, is_publushed TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, lastupdate_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_F41BCA702B36786B (title), INDEX IDX_F41BCA705BB66C05 (poster_id), INDEX IDX_F41BCA7012469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
